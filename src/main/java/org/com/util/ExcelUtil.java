...
/**
 * 
 * 导入导出Excel工具类,使用JXL操作Excel</br>
 * poi功能强大，但是比较耗资源，对于大数据量的导入导出性能不是太好</br>
 * jxl功能简单，但是性能比较好</br>
 * 
 * @author binary
 *
...
public class ExcelUtil {
     ...
     */
    public static <T> List<T> excelToList2(InputStream in, String sheetName, Class<T> entityClass,
